...
export const metadata: Metadata = {
  title: "Kitesurfing Moledo Portugal 2026 — Spot Guide, Wind & Lessons | BestKitesurfSchools",
  ...
  openGraph: {
    title: "Kitesurfing Moledo Portugal 2026 — Spot Guide, Wind & Lessons",
    description: "Moledo is northern Portugal's secret kitesurf paradise. Consistent Nortada winds, uncrowded beaches, and Europe's top-rated school. Full spot guide inside.",
    url: "https://bestkitesurfschools.com/kitesurf-moledo",
    images: [{ url: "https://bestkitesurfschools.com/images/kitesurf-moledo-portugal.jpg", width: 1200, height: 630, alt: "Kitesurfing Moledo Portugal" }],
    type: "article",
  },
};
