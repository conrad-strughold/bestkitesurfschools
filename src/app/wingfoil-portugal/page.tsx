...
export const metadata: Metadata = {
  title: "Wingfoil Portugal 2026 — Best Spots, Lessons & Conditions | BestKitesurfSchools",
  ...
  openGraph: {
    title: "Wingfoil Portugal 2026 — Best Spots, Lessons & Conditions",
    ...
    images: [{ url: "https://bestkitesurfschools.com/images/wingfoil-portugal-action.jpg", width: 1200, height: 630, alt: "Wingfoiling in Portugal" }],
    type: "article",
  },
};
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "headline": "Wingfoiling in Portugal — Lessons, Spots & Season Guide",
      ...
      <header className="relative min-h-[65svh] w-full flex flex-col justify-end pt-40 pb-20 px-6 md:px-16 lg:px-24 bg-[#171717]">
        <div className="absolute inset-0 z-0">
          <Image src="/images/wingfoil-portugal-action.jpg" alt="Wingfoiling in Portugal" fill className="object-cover opacity-75 mix-blend-overlay" priority />
