...
export const metadata: Metadata = {
  title: "Kitesurfing in Dakhla, Morocco 2026 — Flat Water, Constant Wind | BestKitesurfSchools",
  ...
  openGraph: {
    title: "Kitesurfing in Dakhla, Morocco 2026 — Flat Water, Constant Wind",
  ...
  return (
    <>
      ...
      <header className="relative min-h-[55svh] w-full flex flex-col justify-end pt-40 pb-20 px-6 md:px-16 lg:px-24 bg-[#171717]">
        <div className="absolute inset-0 bg-gradient-to-br from-[#744210] to-[#171717]"></div>
        <div className="relative z-10 w-full max-w-[1000px] mx-auto">
          ...
          <p className="text-white/60 font-light text-lg">Spot Guide, Lagoon Conditions & Travel Tips — 2026</p>
        </div>
      </header>
            ...
            <article className="lg:w-2/3 max-w-[720px]">
              ...
              <aside className="border-l-4 border-[#1A365D] bg-[#F0EDE6] p-8 mb-12">
                ...
                <ul className="space-y-2 text-sm text-[#171717]/80 font-light">
                  <li>• Wind: N / NE Trade winds — among the most consistent on Earth</li>
                  <li>• Average wind: 18–28 knots, 320+ days per year</li>
                  <li>• Water: Flat lagoon (beginners) + open ocean (advanced)</li>
                  <li>• Best season: Year-round — peak Nov–Apr for strongest trades</li>
                  <li>• Level: All levels — lagoon is exceptional for beginners</li>
                </ul>
              </aside>

              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-10">
                Dakhla sits on a narrow peninsula jutting into a vast lagoon in southern Morocco — technically Western Sahara — and it is one of the most geographically gifted kitesurf locations on the planet. The Saharan trade wind system delivers north-northeasterly winds with a consistency that simply does not exist in European spots: 320+ windy days per year, with averages sitting comfortably between 18 and 28 knots. The lagoon is enormous, shallow, and flat — a natural teaching tank of almost absurd dimensions.
              </p>

              <h2 className="font-serif text-3xl mb-5">The Lagoon: Why Dakhla Is Special</h2>
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-10">
                The Dakhla lagoon stretches over 40km in length and sits mostly at knee-to-thigh depth across its inland zones. The water surface on classic trade wind days is remarkably flat — almost lake-like in the sheltered central sections. For beginner kitesurfers, this translates into extended body-dragging sessions and water starts without wrestling swell or navigating current. For advanced freeride and freestyle riders, the open Atlantic ocean side of the peninsula delivers powerful rolling chop and occasional waves. Dakhla caters to both in a way almost no other destination on Earth does simultaneously.
              </p>

              <h2 className="font-serif text-3xl mb-5">Wind Reliability</h2>
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-10">
                Dakhla&apos;s wind is driven by the Saharan High — a persistent high-pressure system over the African desert that generates reliable trade winds blowing from the north-northeast. Unlike thermal winds (which are restricted to afternoon windows), the Dakhla trades blow throughout the day. Early morning sessions are entirely normal. The peak months of November through April deliver the most powerful winds (20–30 knots), while the summer months are slightly lighter (15–22 knots) but still highly consistent. There are genuinely very few places on Earth with comparable year-round wind reliability.
              </p>

              <h2 className="font-serif text-3xl mb-5">Getting to Dakhla</h2>
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-6">
                Dakhla Airport (VIL) receives direct charter and scheduled flights from several European cities, with Royal Air Maroc operating connections via Casablanca. Several Dakhla-focused kite camps offer airport transfers as part of all-inclusive packages — the most practical way to handle logistics in a remote destination.
              </p>
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-10">
                Most visitors stay at one of the lagoon-side kite camps, which provide accommodation, meals, equipment, and instruction in a single package. This all-inclusive model suits Dakhla well — the remoteness of the location makes self-organising significantly more complex than a European destination.
              </p>

              <h2 className="font-serif text-3xl mb-5">Dakhla vs European Destinations</h2>
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-10">
                Dakhla wins on raw wind reliability and flat water quality — no European destination comes close on those metrics. The trade-off is logistical complexity, cost (camp packages run €1,200–2,000 per week all-in), and the need to fly to a genuinely remote location. For riders planning a dedicated kitesurf trip, Dakhla is extraordinary. For those integrating a kitesurf course with a broader European trip, <Link href="/kitesurf-portugal" className="underline hover:text-[#319795] transition-colors">Portugal</Link> — particularly <Link href="/kitesurf-moledo" className="underline hover:text-[#319795] transition-colors">northern Portugal</Link> — offers a more accessible combination of excellent conditions and cultural richness.
              </p>
              ...
              <div className="border-t border-[#171717]/10 pt-10">
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li><Link href="/kitesurf-brazil" className="hover:text-[#319795] transition-colors underline">Brazil — Jericoacoara &amp; Beyond</Link></li>
                </ul>
              </div>
            </article>
              ...
              <div className="sticky top-32">
                <div className="border-t border-[#171717]/10 pt-12 mb-12">
                  ...
                  <div className="space-y-5 text-sm">
                    ...
                    <div><span className="text-xs uppercase tracking-widest text-[#171717]/40 block mb-1">Avg Speed</span><span className="font-serif text-xl text-[#1A365D]">18–28 kt</span></div>
                    ...
                    <div><span className="text-xs uppercase tracking-widest text-[#171717]/40 block mb-1">Best Season</span><span className="font-serif text-xl">Year-Round</span></div>
                  </div>
                </div>
