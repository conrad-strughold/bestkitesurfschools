...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Kitesurfing Essaouira Morocco 2026: Spot Guide",
    ...
    images: [{ url: "https://bestkitesurfschools.com/images/essaouira-kitesurf.jpg", width: 1200, height: 630, alt: "Kitesurfing Essaouira Morocco" }],
    type: "article",
  },
};
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "Article",
        "headline": "Kitesurfing in Essaouira, Morocco: Spot Guide 2026",
      ...
      <header className="relative min-h-[65svh] w-full flex flex-col justify-end pt-40 pb-20 px-6 md:px-16 lg:px-24 bg-[#171717]">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/essaouira-kitesurf.jpg"
            alt="Kitesurfing in Essaouira Morocco"
            fill
        ...
        <div className="relative z-10 w-full max-w-[1000px] mx-auto">
          ...
          <p className="text-white/60 font-light text-lg">Atlantic Winds, Medina Culture and Spot Guide: 2026</p>
        </div>
      </header>
            ...
            <article className="lg:w-2/3 max-w-[720px]">
              ...
              <aside className="border-l-4 border-[#1A365D] bg-[#F0EDE6] p-8 mb-12">
                ...
                <ul className="space-y-2 text-sm text-[#171717]/80 font-light">
                  <li>• Wind: N / NE Atlantic trade winds, nicknamed the "wind city of Africa"</li>
                  <li>• Average wind: 20 to 35 knots in peak season</li>
                  <li>• Best season: May to September for strongest, most reliable winds</li>
              ...
              <div className="sticky top-32">
                <div className="border-t border-[#171717]/10 pt-12 mb-12">
                  ...
                  <div className="space-y-5 text-sm">
                    ...
                    <div><span className="text-xs uppercase tracking-widest text-[#171717]/40 block mb-1">Best Season</span><span className="font-serif text-xl">May to Sep</span></div>
                ...
                <div className="border-t border-[#171717]/10 pt-12">
                  <h3 className="text-xs font-medium uppercase tracking-[0.2em] mb-6 text-[#171717]/50">Morocco Guides</h3>
