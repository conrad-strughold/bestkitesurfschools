...
export const metadata: Metadata = {
  title: "Kitesurfing in Brazil 2026 — Jericoacoara, Preá & Best Spots | BestKitesurfSchools",
  description: "Brazil's northeast coast is one of the world's elite kitesurf destinations. Trade winds, warm water, and world-class spots from Jericoacoara to Preá. Full guide.",
  openGraph: {
    title: "Kitesurfing in Brazil 2026 — Jericoacoara, Preá & Best Spots",
    description: "Brazil's northeast coast is one of the world's elite kitesurf destinations. Trade winds, warm water, and world-class spots from Jericoacoara to Preá.",
...
const spots = [
  { name: "Jericoacoara", region: "Ceará", wind: "E / SE Trades", level: "All Levels", crowd: "Medium", note: "The benchmark — reliable wind, vibrant scene, flat lagoon nearby." },
  { name: "Preá", region: "Ceará", wind: "E / SE Trades", level: "Intermediate–Adv", crowd: "Low", note: "The insider's alternative to Jeri. Powerful, great wave potential." },
  { name: "Cumbuco", region: "Ceará", wind: "SE Trades", level: "Beginner–Int", crowd: "Medium", note: "Flat water close to Fortaleza airport. Popular intro spot." },
  { name: "Barra Grande", region: "Piauí", wind: "SE Trades", level: "All Levels", crowd: "Low", note: "Part of the Ilha do Caju lagoon system — extraordinary flat water." },
];
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "Article",
        "headline": "Kitesurfing in Brazil — Best Spots & Season Guide 2026",
      ...
      <header className="relative min-h-[55svh] w-full flex flex-col justify-end pt-40 pb-20 px-6 md:px-16 lg:px-24 bg-[#171717]">
        <div className="absolute inset-0 bg-gradient-to-br from-[#276749] to-[#171717]"></div>
        <div className="relative z-10 w-full max-w-[1000px] mx-auto">
          ...
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white leading-[1.05] tracking-tight mb-6">
            Kitesurfing in Brazil — Best Spots & Season Guide
          </h1>
          <p className="text-white/60 font-light text-lg">Jericoacoara, Preá, Cumbuco &amp; Beyond — 2026</p>
        </div>
      </header>
            ...
            <article className="lg:w-2/3 max-w-[720px]">
              ...
              <aside className="border-l-4 border-[#1A365D] bg-[#F0EDE6] p-8 mb-12">
                ...
                <ul className="space-y-2 text-sm text-[#171717]/80 font-light">
                  <li>• Wind: SE / E Trade winds — 8–9 months of consistent sailing per year</li>
                  <li>• Average wind: 20–30 knots during peak season</li>
                  <li>• Water temperature: 26–30°C — no wetsuit needed</li>
                  <li>• Best season: July–January (northeast coast)</li>
                  <li>• Gateway airport: Fortaleza (FOR) for most top spots</li>
                </ul>
              </aside>

              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-10">
                Brazil&apos;s northeast coast is not just one of the world&apos;s great kitesurf regions — it is genuinely in the argument for the greatest. The combination of south-easterly trade winds that blow with remarkable consistency from July through January, warm crystal water at 28°C, enormous flat-water lagoon systems, and world-class freestyle and wave conditions across hundreds of kilometres of coastline makes the Ceará and Piauí states a dedicated kiter&apos;s dream. Jericoacoara alone carries a mythological status among the global kitesurf community that very few spots on Earth have matched.
              </p>
              ...
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-6">
                The SE trade wind system that drives Brazil&apos;s northeast coast is powered by the South Atlantic High — one of the most stable atmospheric systems on Earth. From approximately July through January, this system delivers a remarkably steady easterly to south-easterly wind directly onto the coastline, running at 20–30 knots the vast majority of days. Water temperatures hover between 26 and 30°C year-round. The combination is almost unreasonably generous.
              </p>
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-10">
                Add to this the unique geography of the region: a coastline studded with freshwater lagoons (called &ldquo;lençóis&rdquo;) fed by seasonal rains, which fill up between February and June and then sit calm and glassy behind natural dune barriers during the dry, windy season. These lagoons are among the finest flat-water kitesurf environments anywhere in the world.
              </p>
              ...
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-6">
                <strong>July–January</strong> is peak season for the northeast coast. The trades are fully active, the lagoons from the previous wet season are still filled, and conditions align perfectly. August and September are statistically the windiest months — 25–30 knot days are common. December through January remain strong but begin transitioning toward the wet season.
              </p>
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-10">
                <strong>February–June</strong> is the wet season in the northeast. The trades weaken significantly, rainfall increases, and kite conditions deteriorate. However, this fills the lagoons that make the July–January season so spectacular — so this downtime is a necessary part of the cycle.
              </p>

              <h2 className="font-serif text-3xl mb-5">Travel Logistics</h2>
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-6">
                <strong>Flying:</strong> Fortaleza International Airport (Pinto Martins, FOR) is the primary gateway for most northeast spots. Direct flights from Lisbon and various European hubs via São Paulo (GRU) or connecting in Fortaleza. Journey time from Europe is typically 11–14 hours with one connection.
              </p>
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-10">
                <strong>Getting around:</strong> A 4WD vehicle is recommended for the best spots — roads to Jericoacoara and Preá involve sand tracks through dunes. Many kite camps offer transfers. Budget approximately €1,000–1,500 per week all-in for a comprehensive kite camp experience.
              </p>
              ...
              <div className="sticky top-32">
                <div className="border-t border-[#171717]/10 pt-12 mb-12">
                  ...
                  <div className="space-y-5 text-sm">
                    ...
                    <div><span className="text-xs uppercase tracking-widest text-[#171717]/40 block mb-1">Peak Wind</span><span className="font-serif text-xl text-[#1A365D]">20–30 kt</span></div>
                    <div><span className="text-xs uppercase tracking-widest text-[#171717]/40 block mb-1">Water Temp</span><span className="font-serif text-xl text-[#319795]">26–30°C</span></div>
                    <div><span className="text-xs uppercase tracking-widest text-[#171717]/40 block mb-1">Best Season</span><span className="font-serif text-xl">Jul–Jan</span></div>
