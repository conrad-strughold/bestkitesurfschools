...
export const metadata: Metadata = {
  title: "Kitesurfing in Tarifa, Spain 2026: Spot Guide, Wind and Schools | BestKitesurfSchools",
  ...
  openGraph: {
    title: "Kitesurfing in Tarifa, Spain 2026: Spot Guide, Wind and Schools",
    description: "Tarifa is Europe's wind capital, but is it right for you? Our honest guide covers the spot, the Levante and Poniente winds, the crowds, and what to expect.",
    url: "https://bestkitesurfschools.com/kitesurf-tarifa-spain",
    images: [{ url: "https://bestkitesurfschools.com/images/tarifa-kitesurf.jpg", width: 1200, height: 630, alt: "Kitesurfing Tarifa Spain" }],
    type: "article",
  },
};
    ...
    <>
      ...
      <header className="relative min-h-[65svh] w-full flex flex-col justify-end pt-40 pb-20 px-6 md:px-16 lg:px-24 bg-[#171717]">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/tarifa-kitesurf.jpg"
            alt="Kitesurfing in Tarifa, Spain"
            fill
        ...
        <div className="relative z-10 w-full max-w-[1000px] mx-auto">
          ...
          <p className="text-white/60 font-light text-lg">Spot Guide, Conditions and Honest Assessment: 2026</p>
        </div>
      </header>
            ...
            <article className="lg:w-2/3 max-w-[720px]">
              ...
              <aside className="border-l-4 border-[#1A365D] bg-[#F0EDE6] p-8 mb-12">
                ...
                <ul className="space-y-2 text-sm text-[#171717]/80 font-light">
                  ...
                  <li>• Average wind speed: 20 to 35 knots on strong days</li>
                  <li>• Best season: April to October (Poniente); year-round (Levante)</li>
              ...
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-10">
                Tarifa earns its reputation for riders who are already competent and seeking powerful, challenging conditions. The strong Levante sessions, the dramatic Strait of Gibraltar backdrop, and the vibrant town infrastructure make it a genuinely compelling destination for those who can handle it. For beginners, calmer and less crowded alternatives, particularly <Link href="/kitesurf-portugal" className="underline hover:text-[#319795] transition-colors">northern Portugal</Link>, deliver a more productive and enjoyable learning environment.
              </p>

              <h2 className="font-serif text-3xl mb-5">Practical Info</h2>
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-6">
                <strong>Getting there:</strong> Malaga Airport (AGP) is the most connected hub, approximately 1.5 hours by car. Algeciras is the nearest large town. Tarifa itself has a compact, lively old town with good accommodation ranging from budget kite camps to boutique hotels.
              </p>
              <p className="text-lg text-[#171717]/70 leading-[1.8] font-light mb-10">
                <strong>Best months:</strong> May to June for Poniente with manageable crowds. September offers the best balance of conditions, temperature, and beach density.
              </p>
              ...
              <div className="sticky top-32">
                <div className="border-t border-[#171717]/10 pt-12 mb-12">
                  ...
                  <div className="space-y-5 text-sm">
                    ...
                    <div><span className="text-xs uppercase tracking-widest text-[#171717]/40 block mb-1">Avg Speed</span><span className="font-serif text-xl text-[#1A365D]">20 to 35 kt</span></div>
                    ...
                    <div><span className="text-xs uppercase tracking-widest text-[#171717]/40 block mb-1">Best Season</span><span className="font-serif text-xl">Apr to Oct</span></div>
                  </div>
                </div>
